...
console.log("inquality test with stirng ", ('apples' as string) != 'mangoes');

// Tests using the lower case function
console.log("lower case function", 'HELLO'.toLowerCase() == 'hello');
console.log("lower case function", ('HELLO') as string != 'hello');


// Numerical tests involving equality and inequality, 
console.log("euqality test with number ", 50 === 50);
console.log("ineuqality test with number ", 50 as number != 10);
...
console.log("less than test with number (inequality) ", 100 as number != 50);
...
let arrayFruits : string []= ['Mango', 'Apple', 'Banana', 'Papaya'];
