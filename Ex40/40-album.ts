...
function make_album(artistName:string, albumTitle:string, track?:number){ 
    ...
    let music: { artistName:string, albumTitle:String, track?:number} = {
...
let album = make_album( 'Atif Aslam', 'Judaai')
console.log(album)

let album1 = make_album( 'Fateh Ali', 'Jugnoo')
console.log(album1)

let album2 = make_album( 'Atif Aslam', 'Judaai', 12)
console.log(album2)
